...
public interface OfficeRepository extends JpaRepository<Office, String> {
    ...
    List<Object[]> findOfficeSpain(String country);
    ...
    @Query("SELECT CONCAT(o.address1, o.address2) AS office_address "
            ...
            + "WHERE c.city = :city")
    List<Object[]> findOfficeAddress(String city);
        ...
        @Query("SELECT DISTINCT o.officeCode "
                ...
                + "WHERE pr.rangeProduct.range = :rangeProduct "
        ...
        List<Object[]> findOfficeEmployeeDontWorkEachProductFrutal(@Param("rangeProduct") String rangeProduct);
